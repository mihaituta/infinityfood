    ...
    export default {
        ...
        data() {
            return {
                ...
                cityRules: [
                    v => !!v || 'Orașul este obligatoriu',
                ],
                user_idRules: [
                    v => !!v || 'Administratorul este obligatoriu',
                ],
                previewDescriptionRules: [
                    v => !!v || 'Descrierea de prezentare este obligatorie',
                ],
                contactTextRules: [
                    v => !!v || 'Descrierea din secțiunea de contact este obligatorie',
                ],
                phone1Rules: [
                ...
                aboutTextRules: [
                    v => !!v || 'Descrierea restaurantului este obligatorie',
                ],
